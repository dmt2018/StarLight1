object frmSalesByClients: TfrmSalesByClients
  Left = 0
  Top = 0
  ...
  object top_panel: TPanel
    ...
    object chb_regions: TcxCheckComboBox
      ...
      Properties.OnEditValueChanged = chb_regionsPropertiesEditValueChanged
      ShowHint = True
      Style.LookAndFeel.Kind = lfOffice11
      Style.LookAndFeel.NativeStyle = True
      StyleDisabled.LookAndFeel.Kind = lfOffice11
  ...
  object bm_clients: TdxBarManager
    ...
    object dxBarManager1Bar1: TdxBar
      ...
      Caption = 'main_top'
      CaptionButtons = <>
      DockControl = bcMainSalesByClient
      DockedDockControl = bcMainSalesByClient
      DockedLeft = 0
      DockedTop = 0
      FloatLeft = 943
      FloatTop = 8
