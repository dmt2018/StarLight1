object DM: TDM
  ...
  Height = 642
  Width = 863
  object Main_session: TOraSession
  ...
  object Q_FL_SUBTYPE: TOraQuery
    ...
    object Q_FL_SUBTYPEFST_ID: TFloatField
      FieldName = 'FST_ID'
      Required = True
    end
    object Q_FL_SUBTYPEF_SUB_TYPE: TStringField
      FieldName = 'F_SUB_TYPE'
      Required = True
      Size = 50
    end
    object Q_FL_SUBTYPEFT_ID: TFloatField
      FieldName = 'FT_ID'
      Required = True
    end
  end
  object Q_FL_SUBTYPE_DS: TOraDataSource
    DataSet = Q_FL_SUBTYPE
    Left = 504
    Top = 72
  end
  ...
  object Q_SQL_SPIS_DS: TOraDataSource
    DataSet = Q_SQL_SPIS
    Left = 232
    Top = 80
  end
  ...
  object Q_STORE: TOraQuery
    ...
    SQL.Strings = (
      ...
      'WHERE '
      '/*Filter*/ 1=1 '
      'AND a.id_departments=:P1'
      'ORDER BY a.f_name_ru')
    Left = 88
    Top = 488
    ParamData = <
      item
    ...
    object Q_STORESTORE_TYPE: TFloatField
      FieldName = 'STORE_TYPE'
      Required = True
    end
    object Q_STOREID_DEPARTMENTS: TIntegerField
      FieldName = 'ID_DEPARTMENTS'
    end
    object Q_STOREFULL_NAME: TStringField
      FieldName = 'FULL_NAME'
      Size = 146
    end
    object Q_STOREF_NAME: TStringField
      FieldName = 'F_NAME'
      Required = True
      Size = 50
    end
    object Q_STOREF_NAME_RU: TStringField
      FieldName = 'F_NAME_RU'
      Required = True
      Size = 50
    end
    object Q_STOREF_TYPE: TStringField
      FieldName = 'F_TYPE'
      Required = True
      Size = 50
    end
    object Q_STOREF_SUB_TYPE: TStringField
      FieldName = 'F_SUB_TYPE'
      Required = True
      Size = 50
    end
    object Q_STORECODE: TStringField
      FieldName = 'CODE'
      Size = 40
    end
    object Q_STORELEN: TIntegerField
      FieldName = 'LEN'
    end
    object Q_STOREPACK: TIntegerField
      FieldName = 'PACK'
    end
    object Q_STORECOLOUR: TStringField
      FieldName = 'COLOUR'
      Required = True
      Size = 50
    end
    object Q_STORECOL_ID: TFloatField
      FieldName = 'COL_ID'
      Required = True
    end
    object Q_STOREFT_ID: TFloatField
      FieldName = 'FT_ID'
      Required = True
    end
    object Q_STOREFST_ID: TFloatField
      FieldName = 'FST_ID'
      Required = True
    end
    object Q_STOREFN_ID: TFloatField
      FieldName = 'FN_ID'
      Required = True
    end
    object Q_STORES_ID: TFloatField
      FieldName = 'S_ID'
      Required = True
    end
    object Q_STOREC_ID: TFloatField
      FieldName = 'C_ID'
      Required = True
    end
    object Q_STOREH_CODE: TStringField
      FieldName = 'H_CODE'
      Size = 30
    end
    object Q_STORECOUNTRY: TStringField
      FieldName = 'COUNTRY'
      Required = True
      Size = 50
    end
    object Q_STOREQUANTITY: TFloatField
      FieldName = 'QUANTITY'
      Required = True
    end
    object Q_STOREN_ID: TFloatField
      FieldName = 'N_ID'
      Required = True
    end
    object Q_STOREPRICE: TFloatField
      FieldName = 'PRICE'
      DisplayFormat = '0.00'
    end
    object Q_STORERESERV: TFloatField
      FieldName = 'RESERV'
    end
    object Q_STOREITOGO: TFloatField
      FieldName = 'ITOGO'
    end
    object Q_STORESPESIFICATION: TStringField
      FieldName = 'SPESIFICATION'
      Size = 4000
    end
  end
  object Q_STORE_DS: TOraDataSource
    DataSet = Q_STORE
    Left = 192
    Top = 488
  end
  ...
  object ins_res_proc: TOraStoredProc
    Session = Main_session
    Left = 640
    Top = 16
  end
  ...
  object Q_ORDERS_ORDERS: TOraQuery
    SQLUpdate.Strings = (
      ...
      'else'
        ...
        '  update ORDERS_CLIENTS set alpha = :alpha, priority = :priority' +
        ' where ID_ORDERS_CLIENTS = :ID_ORDERS_CLIENTS;'
      'end if;'
      ''
      'end;')
    SQLRefresh.Strings = (
    ...
    Session = Main_session
    SQL.Strings = (
      'select 1 as checked, rownum as nn, a.* from'
      '('
      'SELECT '
      ...
      'oo.priority,'
      '('
      '  SELECT COUNT(a.ID_ORDERS_LIST) '
      '  FROM ORDERS_LIST a, nomenclature b'
      
        '  WHERE a.ID_ORDERS_CLIENTS=OO.ID_ORDERS_CLIENTS AND a.ACTIVE=1 ' +
        'and a.n_id = b.n_id and nvl(a.correction,a.quantity) > 0 '
      
        '    and ((b.s_id = o.s_id and const_office = 1) or const_office ' +
        '> 1) and b.notuse = 0'
      ') as SSS,'
      '('
      '  SELECT sum(nvl(a.correction,a.quantity)) '
      '  FROM ORDERS_LIST a, nomenclature b'
      ...
      ',('
      '  select sum(nvl(ol.correction,ol.quantity)*p.price) '
      '  from orders_list ol, price_list p '
      
        '  where ol.id_orders_clients = OO.id_orders_clients and ol.activ' +
        'e = 1 and ol.n_id = p.n_id '
      ') as sum_price '
      ', case when const_office = 1 then ('
      '  select count(1) as nn from orders_list ol, nomenclature n'
      
        '  where ol.id_orders_clients = oo.id_orders_clients and ol.activ' +
        'e = 1 and ol.n_id = n.n_id and n.S_ID <> o.s_id'
      ') else 0 end have_notvalid_flowers'
      ', ('
      '  select count(1) as nn from orders_list ol, nomenclature n'
      
        '  where ol.id_orders_clients = oo.id_orders_clients and ol.activ' +
        'e = 1 and ol.n_id = n.n_id and n.notuse = 1'
      ') as have_old_flowers'
      'FROM '
      'ORDERS_CLIENTS OO, '
      'CLIENTS C, '
    ...
    FilterOptions = [foCaseInsensitive]
    BeforeEdit = Q_ORDERS_ORDERSBeforeEdit
    AfterPost = Q_ORDERS_ORDERSAfterPost
    Left = 48
    Top = 288
    ParamData = <
      item
    ...
    object Q_ORDERS_ORDERSSSS: TFloatField
      FieldName = 'SSS'
    end
    object Q_ORDERS_ORDERSNN: TFloatField
      FieldName = 'NN'
    end
    object Q_ORDERS_ORDERSWEIGHT: TFloatField
      FieldName = 'WEIGHT'
      DisplayFormat = '0.000'
    end
    object Q_ORDERS_ORDERSPACK_: TIntegerField
      FieldName = 'PACK_'
    end
    ...
    object Q_ORDERS_ORDERSNICK_USER: TStringField
      FieldName = 'NICK_USER'
      Required = True
    end
    ...
    object Q_ORDERS_ORDERSCHECKED: TFloatField
      FieldName = 'CHECKED'
    end
    object Q_ORDERS_ORDERSQQQ: TFloatField
      FieldName = 'QQQ'
    end
    object Q_ORDERS_ORDERSSUM_PRICE: TFloatField
      FieldName = 'SUM_PRICE'
    end
    object Q_ORDERS_ORDERSHAVE_NOTVALID_FLOWERS: TFloatField
      FieldName = 'HAVE_NOTVALID_FLOWERS'
    end
    object Q_ORDERS_ORDERSBLOCK1: TIntegerField
      FieldName = 'BLOCK1'
    end
    object Q_ORDERS_ORDERSBLOCK2: TIntegerField
      FieldName = 'BLOCK2'
    end
    object Q_ORDERS_ORDERSHAVE_OLD_FLOWERS: TFloatField
      FieldName = 'HAVE_OLD_FLOWERS'
    end
    object Q_ORDERS_ORDERSPRIORITY: TIntegerField
      FieldName = 'PRIORITY'
    end
  end
  object Q_ORDERS_ORDERS_DS: TOraDataSource
    DataSet = Q_ORDERS_ORDERS
    Left = 184
    Top = 288
  end
  object Q_ORDERS_LIST: TOraStoredProc
    StoredProcName = 'pack_orders.get_nomenclature'
    SQLUpdate.Strings = (
      'begin '
      '  if :pack_ <> :OLD_pack_ or :count_data <> :OLD_count_data then'
      '    if :FL_ORDERS is not null then'
      
        '      UPDATE ORDERS_LIST SET pack_=:pack_, count_data=:count_dat' +
        'a, date_change=sysdate WHERE ID_ORDERS_LIST=:ID_ORDERS_LIST;'
      '    end if;'
      '  else'
      
        '    pack_orders.INS_ORDERS(:ID_ORDERS_CLIENTS, :N_ID, nvl(:FL_OR' +
        'DERS,0), :TRUCK, :SUB_WEIGHT, null, :remarks_tmp);'
      '  end if;'
      'end;')
    SQLRefresh.Strings = (
      'select '
      ...
      '  l.truck,'
      '  --o.eng_name as h_name,'
      '  l.remarks as remarks_tmp,'
      '  l.id_orders_list,'
      '  l.count_data '
      'from '
      '  orders_list l'
      
        '  --inner join orders_clients cl on cl.id_orders_clients = l.ID_' +
        'ORDERS_CLIENTS'
      
        '  --left outer join orders_remarks r on r.id_orders = cl.id_orde' +
        'rs and r.n_id = l.n_id'
      '  left outer join orders_name o on o.n_id = l.n_id'
      'where '
      '  l.N_ID = :OLD_N_ID'
      '  AND l.ID_ORDERS_CLIENTS = :OLD_ID_ORDERS_CLIENTS'
      '  and nvl(l.remarks,'#39'-'#39') = nvl(:OLD_remarks_tmp,'#39'-'#39')')
    Session = Main_session
    SQL.Strings = (
      'begin'
      
        '  pack_orders.get_nomenclature(:ADDIT_, :ID_DEP_, :ID_CL_, :ID_,' +
        ' :SPEC_, :TRUC_DATE_, :BUTTON_, :IN_INVOICE_1_, :IN_INVOICE_2_, ' +
        ':IN_STOCK_1_, :IN_STOCK_2_, :CURSOR_);'
      'end;')
    FetchRows = 50
    FetchAll = True
    FilterOptions = [foCaseInsensitive]
    BeforePost = Q_ORDERS_LISTBeforePost
    AfterPost = Q_ORDERS_LIST_OLDAfterPost
    Left = 48
    Top = 336
    ParamData = <
      item
    ...
    object Q_ORDERS_LISTH_NAME: TStringField
      FieldName = 'H_NAME'
      Size = 256
    end
    object Q_ORDERS_LISTF_NAME: TStringField
      FieldName = 'F_NAME'
      Size = 256
    end
    object Q_ORDERS_LISTFN_ID: TFloatField
      FieldName = 'FN_ID'
      Required = True
    end
    object Q_ORDERS_LISTF_SUB_TYPE: TStringField
      FieldName = 'F_SUB_TYPE'
      Required = True
      Size = 50
    end
    object Q_ORDERS_LISTF_TYPE: TStringField
      FieldName = 'F_TYPE'
      Required = True
      Size = 50
    end
    object Q_ORDERS_LISTN_ID: TFloatField
      FieldName = 'N_ID'
      Required = True
    end
    object Q_ORDERS_LISTLEN: TIntegerField
      FieldName = 'LEN'
    end
    object Q_ORDERS_LISTPACK: TIntegerField
      FieldName = 'PACK'
    end
    object Q_ORDERS_LISTVBN: TIntegerField
      FieldName = 'VBN'
      Required = True
    end
    object Q_ORDERS_LISTWEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object Q_ORDERS_LISTFST_ID: TFloatField
      FieldName = 'FST_ID'
      Required = True
    end
    object Q_ORDERS_LISTFT_ID: TFloatField
      FieldName = 'FT_ID'
      Required = True
    end
    object Q_ORDERS_LISTC_ID: TFloatField
      FieldName = 'C_ID'
      Required = True
    end
    object Q_ORDERS_LISTS_ID: TFloatField
      FieldName = 'S_ID'
      Required = True
    end
    object Q_ORDERS_LISTS_NAME_RU: TStringField
      FieldName = 'S_NAME_RU'
      Required = True
      Size = 150
    end
    object Q_ORDERS_LISTCOLOUR: TStringField
      FieldName = 'COLOUR'
      Required = True
      Size = 50
    end
    object Q_ORDERS_LISTCOL_ID: TFloatField
      FieldName = 'COL_ID'
      Required = True
    end
    object Q_ORDERS_LISTCOUNTRY: TStringField
      FieldName = 'COUNTRY'
      Required = True
      Size = 50
    end
    object Q_ORDERS_LISTID_DEPARTMENTS: TFloatField
      FieldName = 'ID_DEPARTMENTS'
      Required = True
    end
    object Q_ORDERS_LISTHOL_SUB_TYPE: TStringField
      FieldName = 'HOL_SUB_TYPE'
      Size = 50
    end
    object Q_ORDERS_LISTREMARKS: TStringField
      FieldName = 'REMARKS'
      Size = 256
    end
    object Q_ORDERS_LISTHT_ID: TFloatField
      FieldName = 'HT_ID'
    end
    object Q_ORDERS_LISTRUS_MARKS: TStringField
      FieldName = 'RUS_MARKS'
      Size = 4000
    end
    ...
    object Q_ORDERS_LISTSUB_WEIGHT: TFloatField
      FieldName = 'SUB_WEIGHT'
    end
    object Q_ORDERS_LISTSTORE_ALL: TFloatField
      FieldName = 'STORE_ALL'
    end
    object Q_ORDERS_LISTID_ORDERS_CLIENTS: TFloatField
      FieldName = 'ID_ORDERS_CLIENTS'
    end
    object Q_ORDERS_LISTFL_ORDERS_ALL: TFloatField
      FieldName = 'FL_ORDERS_ALL'
    end
    object Q_ORDERS_LISTFL_ORDERS: TFloatField
      FieldName = 'FL_ORDERS'
    end
    object Q_ORDERS_LISTID_ORDERS_LIST: TFloatField
      FieldName = 'ID_ORDERS_LIST'
    end
    object Q_ORDERS_LISTZATIRKA: TIntegerField
      FieldName = 'ZATIRKA'
    end
    object Q_ORDERS_LISTTRUCK: TIntegerField
      FieldName = 'TRUCK'
    end
    object Q_ORDERS_LISTBAR_CODE: TStringField
      FieldName = 'BAR_CODE'
      Size = 30
    end
    object Q_ORDERS_LISTCODE: TFloatField
      FieldName = 'CODE'
    end
    object Q_ORDERS_LISTSTORE_SPIS: TFloatField
      FieldName = 'STORE_SPIS'
    end
    object Q_ORDERS_LISTSTORE_UCEN: TFloatField
      FieldName = 'STORE_UCEN'
    end
    object Q_ORDERS_LISTSTORE_PROD: TFloatField
      FieldName = 'STORE_PROD'
    end
    object Q_ORDERS_LISTCOUNT_DATA: TIntegerField
      FieldName = 'COUNT_DATA'
    end
    object Q_ORDERS_LISTREMARKS_TMP: TStringField
      FieldName = 'REMARKS_TMP'
      Size = 50
    end
    object Q_ORDERS_LISTPRICE: TFloatField
      FieldName = 'PRICE'
    end
    object Q_ORDERS_LISTPACK_: TFloatField
      FieldName = 'PACK_'
    end
    object Q_ORDERS_LISTNBUTTON: TFloatField
      FieldName = 'NBUTTON'
    end
    object Q_ORDERS_LISTNOM_NEW: TIntegerField
      FieldName = 'NOM_NEW'
    end
    object Q_ORDERS_LISTNOM_START: TIntegerField
      FieldName = 'NOM_START'
    end
    object Q_ORDERS_LISTNOM_END: TIntegerField
      FieldName = 'NOM_END'
    end
    object Q_ORDERS_LISTDIAMETER: TFloatField
      FieldName = 'DIAMETER'
    end
    object Q_ORDERS_LISTWEIGHTDRY: TFloatField
      FieldName = 'WEIGHTDRY'
    end
    object Q_ORDERS_LISTCUST_COEF: TFloatField
      FieldName = 'CUST_COEF'
    end
    object Q_ORDERS_LISTNOPRINT: TIntegerField
      FieldName = 'NOPRINT'
    end
    object Q_ORDERS_LISTNOTUSE: TIntegerField
      FieldName = 'NOTUSE'
    end
    ...
    object Q_ORDERS_LISTID_OFFICE: TIntegerField
      FieldName = 'ID_OFFICE'
    end
    object Q_ORDERS_LISTORD: TFloatField
      FieldName = 'ORD'
    end
    object Q_ORDERS_LISTSPEC: TFloatField
      FieldName = 'SPEC'
    end
    object Q_ORDERS_LISTPREV_STOCK_AMOUNT: TFloatField
      FieldName = 'PREV_STOCK_AMOUNT'
    end
    object Q_ORDERS_LISTSTOCK_DISTRIBUTION: TFloatField
      FieldName = 'STOCK_DISTRIBUTION'
    end
    object Q_ORDERS_LISTCLIENT_DISTRIBUTION: TFloatField
      FieldName = 'CLIENT_DISTRIBUTION'
    end
    object Q_ORDERS_LISTCORRECTION: TFloatField
      FieldName = 'CORRECTION'
    end
    object Q_ORDERS_LISTRESERV: TFloatField
      FieldName = 'RESERV'
    end
    object Q_ORDERS_LISTSTOCK_DISTRIBUTION_DONE: TFloatField
  ...
  object Q_ORDERS_LIST_DS: TOraDataSource
    DataSet = Q_ORDERS_LIST
    Left = 184
    Top = 336
  end
  object q_raznos: TOraQuery
    SQLUpdate.Strings = (
      'begin'
      '  if :ZATIRKA = :OLD_ZATIRKA then'
      
        '    PACK_ORDERS.edit_clients_data2(:OLD_ID_ORDERS,:old_n_id,:old' +
        '_remarks_tmp,:sum_corr);'
      '  else'
      'update orders_list a'
      'set a.zatirka = :ZATIRKA'
      
        'where a.n_id = :old_n_id and a.active = 1 and nvl(a.remarks,'#39'-'#39')' +
        ' = nvl(:old_remarks_tmp,'#39'-'#39')'
      'AND a.id_orders_clients in ('
      '  select b.id_orders_clients from orders_clients b'
      '  where b.id_orders = :OLD_ID_ORDERS and b.active = 1'
      '  and b.pack_ = 0'
      ');'
      '  end if;'
      'commit;'
    ...
    SQLRefresh.Strings = (
      'select '
        ...
        '  nvl(case when :old_packed = 1 then 0 else nvl(a.truck,0) end,0' +
        ') truck,'
      '  --nvl(a.truck,0) truck,'
      '  sum(a.weight) as weight,'
      
        '  sum(case when b.id_clients = const_dir then 0 else nvl(a.corre' +
        'ction,a.quantity) end) as sum_n,'
      '  sum(a.correction) as sum_corr, '
      
        '  (select sum(case when z.zatirka=1 then 0 else nvl(z.correction' +
        ',z.quantity) end) '
      '     from orders_list z, orders_clients y '
      
        '     where z.n_id = a.n_id and nvl(z.remarks,'#39'-'#39') = nvl(a.remark' +
        's,'#39'-'#39') and z.id_orders_clients = y.id_orders_clients and y.id_or' +
        'ders = :OLD_ID_ORDERS and y.active = 1 /*and y.id_clients <> con' +
        'st_dir*/'
      '  ) as sum_itog,'
      
        '  sum(case when b.id_clients = const_dir then a.quantity else 0 ' +
        'end) as sum_dir'
      'FROM orders_list a, orders_clients b'
      'WHERE a.id_orders_clients = b.id_orders_clients '
      '  and b.id_orders = :OLD_ID_ORDERS  '
      '  and a.active = 1 '
      '  and b.active = 1'
      '  and a.n_id = :old_N_id '
      '  --and nvl(a.truck,0) = :old_truck'
      '  --and (nvl(a.truck,0) = :old_truck or :old_truck = 99)'
      '  and (b.pack_ = 0 or :old_packed = 1)'
      '  and (b.pack_ = :OLD_packed or :OLD_packed = 1)'
      '  and nvl(a.remarks,'#39'-'#39') = nvl(:old_remarks_tmp,'#39'-'#39')'
      
        'group by b.ID_ORDERS, a.n_id, a.remarks, case when :old_packed =' +
        ' 1 then 0 else nvl(a.truck,0) end')
    SQL.Strings = (
      
        'select a.n_id, nvl(case when :packed_ = 1 then 0 else nvl(a.truc' +
        'k,0) end,0) truck'
      ', sum(a.weight) as weight '
      
        '--, sum(case when a.quantity = a.correction or b.id_clients = co' +
        'nst_dir then 0 else a.quantity end) as sum_n '
      ...
      '     from orders_list z, orders_clients y '
        ...
        '     where z.n_id = a.n_id and nvl(z.remarks,'#39'-'#39') = nvl(a.remark' +
        's,'#39'-'#39') and z.id_orders_clients = y.id_orders_clients and y.id_or' +
        'ders = :ID_ORDERS and y.pack_ = 1 and y.active = 1'
      '  ) as sum_pack'
      ...
      '     from orders_list z, orders_clients y '
        ...
        '     where z.n_id = a.n_id and nvl(z.remarks,'#39'-'#39') = nvl(a.remark' +
        's,'#39'-'#39') and z.id_orders_clients = y.id_orders_clients and y.id_or' +
        'ders = :ID_ORDERS and y.active = 1 /*and y.id_clients <> const_d' +
        'ir*/'
      '  ) as sum_itog'
      ', max(a.zatirka) as zatirka'
      ', b.id_orders'
      '--, b.pack_'
      ', N.VBN, N.LEN, N.PACK'
      ', n.h_name||'#39' '#39'||a.remarks as h_name'
      
        ', n.NAME_CODE, n.h_code, nvl(a.remarks,n.remarks) as remarks, n.' +
        'F_NAME'
      ', n.compiled_name_otdel||'#39' '#39'||a.remarks as compiled_name_otdel'
      ', n.COUNTRY, n.F_SUB_TYPE, n.F_TYPE, n.hol_SUB_TYPE, n.fst_id'
      ', to_number(:packed_) as packed '
      ', ht.ord, n.HOL_TYPE, ht.HOL_TYPE_'
      ', a.remarks as remarks_tmp'
      
        'FROM orders_list a, orders_clients b, NOMENCLATURE_mat_view N, B' +
        'UTTONS_SET z, (SELECT a.hol_type as hol_type_, a.ord, a.ht_id FR' +
        'OM hol_types a) ht'
      'WHERE '
      '/*Filter*/ 1=1 '
      'AND a.id_orders_clients = b.id_orders_clients '
      'and b.id_orders = :ID_ORDERS  '
      'and a.N_ID = N.N_ID '
      ' and n.notuse = 0'
      'and a.active=1 '
      'and b.active = 1 and b.n_type < 2'
      'and (a.quantity <> 0 or a.correction <> 0)'
      'and (nvl(a.truck,0) = :truck_ or :truck_ = 99)'
      'and n.fst_id = z.fst_id(+) '
      'and (b.pack_ = :packed_ or :packed_ = 1)'
      'and n.hol_type = ht.hol_type_(+)'
      
        'group by a.n_id, case when :packed_ = 1 then 0 else nvl(a.truck,' +
        '0) end, N.VBN, N.LEN, N.PACK, n.NAME_CODE, n.HOL_TYPE, n.h_code,' +
        ' n.remarks, '
      
        'n.F_NAME, n.compiled_name_otdel||'#39' '#39'||a.remarks, n.COUNTRY, n.F_' +
        'SUB_TYPE, n.hol_SUB_TYPE, n.F_TYPE, b.id_orders, n.h_name||'#39' '#39'||' +
        'a.remarks, n.fst_id, z.nbutton, ht.ord, ht.HOL_TYPE_, a.remarks')
    MasterSource = Q_ORDERS_DS
    MasterFields = 'ID_ORDERS'
    FetchAll = True
    RefreshOptions = [roAfterUpdate]
    ...
    object q_raznosN_ID: TFloatField
      FieldName = 'N_ID'
      Required = True
    end
    object q_raznosTRUCK: TFloatField
      FieldName = 'TRUCK'
    end
    object q_raznosWEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object q_raznosSUM_N: TFloatField
      FieldName = 'SUM_N'
    end
    object q_raznosSUM_CORR: TFloatField
      FieldName = 'SUM_CORR'
    end
    object q_raznosSUM_DIR: TFloatField
      FieldName = 'SUM_DIR'
    end
    object q_raznosSUM_PACK: TFloatField
      FieldName = 'SUM_PACK'
    end
    object q_raznosSUM_ITOG: TFloatField
      FieldName = 'SUM_ITOG'
    end
    object q_raznosZATIRKA: TFloatField
      FieldName = 'ZATIRKA'
    end
    object q_raznosID_ORDERS: TFloatField
      FieldName = 'ID_ORDERS'
    end
    object q_raznosVBN: TIntegerField
      FieldName = 'VBN'
    end
    object q_raznosLEN: TIntegerField
      FieldName = 'LEN'
    end
    object q_raznosPACK: TIntegerField
      FieldName = 'PACK'
    end
    object q_raznosH_NAME: TStringField
      FieldName = 'H_NAME'
      Size = 256
    end
    object q_raznosNAME_CODE: TStringField
      FieldName = 'NAME_CODE'
    end
    object q_raznosH_CODE: TStringField
      FieldName = 'H_CODE'
      Size = 80
    end
    object q_raznosREMARKS: TStringField
      FieldName = 'REMARKS'
      Size = 256
    end
    object q_raznosF_NAME: TStringField
      FieldName = 'F_NAME'
      Size = 256
    end
    object q_raznosCOMPILED_NAME_OTDEL: TStringField
      FieldName = 'COMPILED_NAME_OTDEL'
      Size = 400
    end
    object q_raznosCOUNTRY: TStringField
      FieldName = 'COUNTRY'
      Size = 50
    end
    object q_raznosF_SUB_TYPE: TStringField
      FieldName = 'F_SUB_TYPE'
      Size = 50
    end
    object q_raznosF_TYPE: TStringField
      FieldName = 'F_TYPE'
      Size = 50
    end
    object q_raznosHOL_SUB_TYPE: TStringField
      FieldName = 'HOL_SUB_TYPE'
      Size = 50
    end
    object q_raznosFST_ID: TFloatField
      FieldName = 'FST_ID'
    end
    object q_raznosPACKED: TFloatField
      FieldName = 'PACKED'
    end
    object q_raznosORD: TFloatField
      FieldName = 'ORD'
    end
    object q_raznosHOL_TYPE: TStringField
      FieldName = 'HOL_TYPE'
    end
    object q_raznosHOL_TYPE_: TStringField
      FieldName = 'HOL_TYPE_'
    end
    object q_raznosREMARKS_TMP: TStringField
      FieldName = 'REMARKS_TMP'
      Size = 50
    end
  end
  object q_raznos_ds: TOraDataSource
    DataSet = q_raznos
    Left = 664
    Top = 544
  end
  object q_raznos_st: TOraQuery
    SQL.Strings = (
      'select nvl(a.truck,0) truck, sum(a.weight) as weight, '
      
        '  --sum(case when a.quantity = a.correction or b.id_clients = co' +
        'nst_dir then 0 else a.quantity end) as qqq,'
      ...
      '  AND a.id_orders_clients = b.id_orders_clients '
      '  and b.id_orders = :ID_ORDERS '
      '  and a.N_ID = N.N_ID and b.n_type < 2'
      '  and a.active = 1 and b.active = 1'
      '  AND n.Fst_Id = FST_VIEW.FST_ID(+)'
      '  and a.quantity <> 0'
      '  and (nvl(a.truck,0) = :truck_ or :truck_ = 99)'
      '  and (b.pack_ = :packed_ or :packed_ = 1)'
      '  and n.notuse = 0'
      
        'group by nvl(a.truck,0), FST_VIEW.ft_id, FST_VIEW.fst_id, FST_VI' +
        'EW.F_SUB_TYPE, FST_VIEW.F_TYPE, fst_view.hol_sub_type, b.id_orde' +
        'rs'
      'ORDER BY fst_view.hol_sub_type')
    MasterSource = Q_ORDERS_DS
    MasterFields = 'ID_ORDERS'
    Left = 584
    Top = 496
    ...
    object q_raznos_stTRUCK: TFloatField
      FieldName = 'TRUCK'
    end
    object q_raznos_stWEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object q_raznos_stQQQ: TFloatField
      FieldName = 'QQQ'
    end
    object q_raznos_stID_ORDERS: TFloatField
      FieldName = 'ID_ORDERS'
      Required = True
    end
    object q_raznos_stF_SUB_TYPE: TStringField
      FieldName = 'F_SUB_TYPE'
      Size = 50
    end
    object q_raznos_stF_TYPE: TStringField
      FieldName = 'F_TYPE'
      Size = 50
    end
    object q_raznos_stHOL_SUB_TYPE: TStringField
      FieldName = 'HOL_SUB_TYPE'
      Size = 50
    end
    object q_raznos_stFT_ID: TFloatField
      FieldName = 'FT_ID'
    end
  ...
  object q_raznos_t: TOraQuery
    ...
    SQL.Strings = (
      ...
      '  and a.N_ID = N.N_ID and b.n_type < 2'
      '  AND n.Fst_Id = FST_VIEW.FST_ID(+)'
      '  and a.active = 1 and b.active = 1 and a.quantity <> 0'
      '  and (nvl(a.truck,0) = :truck_ or :truck_ = 99)'
      '  and (b.pack_ = :packed_ or :packed_ = 1)'
      '  and n.notuse = 0'
      
        'group by nvl(a.truck,0), FST_VIEW.ft_id, FST_VIEW.F_TYPE, b.id_o' +
        'rders'
      'ORDER BY decode(F_TYPE,'#39'N/A'#39','#39#1103#1103#1103#1103#1103#39',F_TYPE)')
    MasterSource = Q_ORDERS_DS
    MasterFields = 'ID_ORDERS'
    Left = 496
    Top = 496
    ...
    object q_raznos_tTRUCK: TFloatField
      FieldName = 'TRUCK'
    end
    object q_raznos_tWEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object q_raznos_tQQQ: TFloatField
      FieldName = 'QQQ'
    end
    object q_raznos_tID_ORDERS: TFloatField
      FieldName = 'ID_ORDERS'
      Required = True
    end
    object q_raznos_tF_TYPE: TStringField
      FieldName = 'F_TYPE'
      Size = 50
    end
  ...
  object q_raznos_2: TOraQuery
    SQLRefresh.Strings = (
      'WHERE'
      '  OCO.ID_ORDERS_LIST = :ID_ORDERS_LIST')
    Session = Main_session
    SQL.Strings = (
      'select '
      'a.n_id, '
      ...
      'WHERE '
      '/*Filter*/ 1=1'
      'and b.id_clients = cil.id_clients '
      'AND a.id_orders_clients = b.id_orders_clients '
      'and b.id_orders=:ID_ORDERS '
      'and a.N_ID=N.N_ID '
      'AND (FST_VIEW.FST_ID(+) = N.Fst_Id)'
      'AND N.FN_ID(+)=FN.FN_ID '
      'AND C.C_ID(+)=N.C_ID'
      'and a.quantity <> 0'
      'and a.active = 1'
      'and b.active = 1'
      'and n.notuse = 0'
      'AND cil.nick not like '#39'%\_'#39
      'ESCAPE '#39'\'#39
      'group by '
      'a.n_id, '
      'a.truck, '
      ...
      'cil.nick,'
      'N.HOL_TYPE'
      'ORDER BY N.HOL_TYPE, FN.F_NAME_RU')
    MasterFields = 'ID_ORDERS'
    Left = 736
    Top = 496
    ParamData = <
    ...
    object q_raznos_2N_ID: TFloatField
      FieldName = 'N_ID'
      Required = True
    end
    object q_raznos_2TRUCK: TIntegerField
      FieldName = 'TRUCK'
    end
    object q_raznos_2WEIGHT: TFloatField
      FieldName = 'WEIGHT'
    end
    object q_raznos_2SUM_N: TFloatField
      FieldName = 'SUM_N'
    end
    object q_raznos_2ID_ORDERS: TFloatField
      FieldName = 'ID_ORDERS'
      Required = True
    end
    object q_raznos_2NICK: TStringField
      FieldName = 'NICK'
      Required = True
    end
    object q_raznos_2VBN: TIntegerField
      FieldName = 'VBN'
    end
    object q_raznos_2LEN: TIntegerField
      FieldName = 'LEN'
    end
    object q_raznos_2PACK: TIntegerField
      FieldName = 'PACK'
    end
    object q_raznos_2HOL_TYPE: TStringField
      FieldName = 'HOL_TYPE'
      Size = 5
    end
    object q_raznos_2F_NAME_RU: TStringField
      FieldName = 'F_NAME_RU'
      Required = True
      Size = 256
    end
    object q_raznos_2COUNTRY: TStringField
      FieldName = 'COUNTRY'
      Size = 50
    end
    object q_raznos_2F_SUB_TYPE: TStringField
      FieldName = 'F_SUB_TYPE'
      Size = 50
    end
    object q_raznos_2F_TYPE: TStringField
      FieldName = 'F_TYPE'
      Size = 50
    end
  end
  object q_raznos_2_ds: TOraDataSource
    DataSet = q_raznos_2
    Left = 736
    Top = 544
  end
  object store_exec: TOraStoredProc
    StoredProcName = 'pack_orders.get_reserv'
    SQLUpdate.Strings = (
      
        'begin INS_RESERV(:ID_ORDERS_CLIENTS, :N_ID, :QUANTITY, :OLD_QUAN' +
        'TITY); end;')
    SQLRefresh.Strings = (
      'SELECT'
      ' a.store_type,'
      ...
      ' a.price,'
      ' a.reserv,'
      ' (a.quantity-a.reserv) as itogo,'
      ' b.ID_ORDERS_LIST,'
      ' b.QUANTITY,'
      ' b.QUANTITY * a.price as aaa,'
      '-- ID_ORDERS_CLIENTS_ as ID_ORDERS_CLIENTS,'
      
        ' case when :ttt = 1 then spesification else null end as spesific' +
        'ation,'
      ' :ttt'
      'FROM'
      '  store_view a,'
      '  ('
      '  select OCO.ID_ORDERS_LIST,'
      #9'OCO.QUANTITY,'
      #9'OCO.ID_ORDERS_CLIENTS,'
      #9'oco.n_id,'
      #9'oco.active'
      '  from S_ORDERS.ORDERS_LIST OCO'
      '  where oco.active = 1'
      '        AND ID_ORDERS_CLIENTS = :ID_ORDERS_CLIENTS '
      '   ) b'
      ' WHERE a.n_id = b.n_id(+)'
      '       and a.N_ID = :N_ID'
      '       --and ID_ORDERS_LIST = :ID_ORDERS_LIST'
      '       --and ID_ORDERS_CLIENTS = :ID_ORDERS_CLIENTS')
    Session = Main_session
    SQL.Strings = (
      'begin'
      
        '  pack_orders.get_reserv(:ID_ORDERS_CLIENTS_, :ID_DEP_, :TYPE_, ' +
        ':CURSOR_);'
      'end;')
    FetchRows = 50
    FetchAll = True
  ...
  object fr_order_orders: TfrxDBDataset
    UserName = 'FR_order_orders'
  ...
  object fr_orders: TfrxDBDataset
    UserName = 'FR_orders'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ID_ORDERS=ID_ORDERS'
      'INVOICE=INVOICE'
      'D_DATE=D_DATE'
      'DATE_TRUCK=DATE_TRUCK'
      'INFO=INFO'
      'NUMM=NUMM'
      'NN=NN'
      'DATE_TRUCK_OUT=DATE_TRUCK_OUT'
      'CHECKED=CHECKED'
      'DIST_IND_ID=DIST_IND_ID'
      'ORDER_SEQ=ORDER_SEQ')
    DataSource = Q_ORDERS_DS
    BCDToCurrency = False
    Left = 568
    Top = 257
  end
  object fr_order_list: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'RUS_MARKS=RUS_MARKS'
      'H_CODE=H_CODE'
      'PRIH_FUTURE=prih_future'
      'PRIH_POST=prih_post'
      'HOL_TYPE=HOL_TYPE'
      'SUB_WEIGHT=SUB_WEIGHT'
      'STORE_ALL=STORE_ALL'
      'ID_ORDERS_CLIENTS=ID_ORDERS_CLIENTS'
      'FL_ORDERS_ALL=FL_ORDERS_ALL'
      'FL_ORDERS=FL_ORDERS'
  ...
  object cdsOrderMSK: TOraQuery
    Session = Main_session
    SQL.Strings = (
      
        'select a.n_id, a.quantity, n.code, n.compiled_name_otdel, p.pric' +
        'e,  n.len, n.colour'
      
        '    from orders_list a, orders_clients b, nomenclature_mat_view ' +
        'n, price_list p'
      '    where a.id_orders_clients = b.id_orders_clients'
      '        and a.active = 1 and a.zatirka = 0'
      '        and a.n_id = n.n_id'
      '        and b.id_orders = :pOrder'
      '        and (b.id_clients = :pClient or :pClient = 0)'
      '        and b.active = 1'
      '        and a.quantity > 0'
      '        and n.n_id = p.n_id(+)'
    ...
    object cdsOrderMSKN_ID: TFloatField
      FieldName = 'N_ID'
      Required = True
    end
    object cdsOrderMSKQUANTITY: TIntegerField
      FieldName = 'QUANTITY'
      Required = True
    end
    object cdsOrderMSKCODE: TFloatField
      FieldName = 'CODE'
    end
    object cdsOrderMSKCOMPILED_NAME_OTDEL: TStringField
      FieldName = 'COMPILED_NAME_OTDEL'
      Size = 350
    end
    object cdsOrderMSKPRICE: TFloatField
      FieldName = 'PRICE'
    end
    object cdsOrderMSKLEN: TIntegerField
      FieldName = 'LEN'
    end
    object cdsOrderMSKCOLOUR: TStringField
      FieldName = 'COLOUR'
      Required = True
      Size = 50
    end
  end
  object dsOrderMSK: TOraDataSource
    DataSet = cdsOrderMSK
    Left = 304
    Top = 512
  end
  object frxOrderMsk: TfrxDBDataset
    UserName = 'frxOrderMsk'
    CloseDataSource = False
    FieldAliases.Strings = (
      'N_ID=N_ID'
      'QUANTITY=QUANTITY'
      ...
      'LEN=LEN'
      'COLOUR=COLOUR')
    DataSource = dsOrderMSK
    BCDToCurrency = False
    Left = 304
    Top = 569
  end
  object frxOrderTotal: TfrxDBDataset
    UserName = 'frxOrderTotal'
    CloseDataSource = False
    FieldAliases.Strings = (
      'N_ID=N_ID'
      'CODE=CODE'
      ...
      'STOK=STOK'
      'SUMM=SUMM')
    DataSource = dsOrderTotal
    BCDToCurrency = False
    Left = 392
    Top = 569
  end
  object dsOrderTotal: TOraDataSource
    DataSet = cdsOrderTotal
    Left = 392
    Top = 512
  end
  object cdsOrderTotal: TOraQuery
    Session = Main_session
    SQL.Strings = (
      
        'select a.n_id, n.code, n.compiled_name_otdel, nvl(p.price,0) as ' +
        'price, n.len, n.colour'
      ', sum(a.quantity) as quantity'
      
        ', sum(case when :pClient = b.id_clients then a.quantity else 0 e' +
        'nd) stok '
      ', sum(nvl(p.price,0) * a.quantity) summ'
      ...
      '        and n.n_id = p.n_id(+)'
        ...
        'group by a.n_id, n.code, n.compiled_name_otdel, p.price, n.len, ' +
        'n.colour'
      'order by n.compiled_name_otdel')
    Left = 392
    Top = 456
    ...
    object cdsOrderTotalN_ID: TFloatField
      FieldName = 'N_ID'
      Required = True
    end
    object cdsOrderTotalCODE: TFloatField
      FieldName = 'CODE'
    end
    object cdsOrderTotalCOMPILED_NAME_OTDEL: TStringField
      FieldName = 'COMPILED_NAME_OTDEL'
      Size = 350
    end
    object cdsOrderTotalPRICE: TFloatField
      FieldName = 'PRICE'
    end
    object cdsOrderTotalLEN: TIntegerField
      FieldName = 'LEN'
    end
    object cdsOrderTotalCOLOUR: TStringField
      FieldName = 'COLOUR'
      Required = True
      Size = 50
    end
    object cdsOrderTotalQUANTITY: TFloatField
      FieldName = 'QUANTITY'
    end
    object cdsOrderTotalSTOK: TFloatField
      FieldName = 'STOK'
    end
    object cdsOrderTotalSUMM: TFloatField
      FieldName = 'SUMM'
    end
  end
  object cdsNom: TOraQuery
    SQL.Strings = (
        ...
        'SELECT n_id FROM nomenclature_mat_view where (code = :p_code or ' +
        'bar_code = :p_code) and ID_DEPARTMENTS = :p_dep and notuse = 0')
    Left = 632
    Top = 136
    ParamData = <
      item
  ...
  object cxImageList1: TcxImageList
    ...
    Top = 192
    Bitmap = {
      494C010127002C00C40120002000FFFFFFFF2110FFFFFFFFFFFFFFFF424D3600
  ...
  object cdsNom2: TOraQuery
    SQL.Strings = (
      'SELECT distinct a.n_id '
      'FROM nomenclature_mat_view a'
      
        'left outer join mapping_flowers_kov b on b.nom_code = a.code and' +
        ' b.active = 1'
      
        'where ( a.bar_code = :p_code or code = :p_code or b.barcode = :p' +
        '_code) and ID_DEPARTMENTS = :p_dep')
    Left = 632
    Top = 192
    ParamData = <
      item
    ...
    object cdsNom2N_ID: TFloatField
      FieldName = 'N_ID'
    end
  end
  object fr_raznos: TfrxDBDataset
    UserName = 'fr_raznos'
    CloseDataSource = False
    FieldAliases.Strings = (
      'N_ID=N_ID'
      ...
      'HOL_TYPE=HOL_TYPE'
      'HOL_TYPE_=HOL_TYPE_')
    DataSource = q_raznos_ds
    BCDToCurrency = False
    Left = 568
    Top = 441
  end
  object tmpSQL: TOraQuery
    Session = Main_session
    SQL.Strings = (
      'SELECT OLMER.PARAMS_SET_ID.nextval from DUAL WHERE ID:=ID')
    FetchAll = True
  ...
  object OraQuery1: TOraQuery
    SQLUpdate.Strings = (
      ...
      '  if :ZATIRKA = :OLD_ZATIRKA then'
        ...
        '    PACK_ORDERS.edit_clients_data2(:OLD_ID_ORDERS,:old_n_id,:sum' +
        '_corr);'
      '  else'
      'update orders_list a'
      'set a.zatirka = :ZATIRKA'
      'where a.n_id = :old_n_id and a.active = 1'
      'AND a.id_orders_clients in ('
      '  select b.id_orders_clients from orders_clients b'
      '  where b.id_orders = :OLD_ID_ORDERS and b.active = 1'
      '  and b.pack_ = 0'
    ...
    SQLRefresh.Strings = (
      ...
      '  sum(a.correction) as sum_corr, '
        ...
        '  (select sum(case when z.zatirka=1 then 0 else nvl(z.correction' +
        ',z.quantity) end) from orders_list z, orders_clients y where z.n' +
        '_id = a.n_id and z.remarks = a.remarks and z.id_orders_clients =' +
        ' y.id_orders_clients and y.id_orders = :OLD_ID_ORDERS and y.acti' +
        've = 1 /*and y.id_clients <> const_dir*/) as sum_itog,'
    ...
    SQL.Strings = (
      ...
      ', N.VBN, N.LEN, N.PACK'
      ', n.h_name||'#39' '#39'||a.remarks as h_name'
      ', n.NAME_CODE, n.h_code, n.remarks, n.F_NAME'
      ', n.compiled_name_otdel||'#39' '#39'||a.remarks as compiled_name_otdel'
      ', n.COUNTRY, n.F_SUB_TYPE, n.F_TYPE, n.hol_SUB_TYPE, n.fst_id'
      ', to_number(:packed_) as packed '
      ', ht.ord, n.HOL_TYPE, ht.HOL_TYPE_'
