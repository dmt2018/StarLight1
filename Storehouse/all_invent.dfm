object all_invent_Form: Tall_invent_Form
  Left = 494
  Top = 228
  Caption = #1057#1090#1072#1088#1083#1072#1081#1090' - '#1053#1072#1082#1083#1072#1076#1085#1099#1077' '#1080#1085#1074#1077#1085#1090#1072#1088#1080#1079#1072#1094#1080#1080
  ClientHeight = 569
  ClientWidth = 954
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Panel5: TPanel
      ...
      object Label1: TLabel
        ...
        Align = alCustom
        Alignment = taCenter
        Caption = #1053#1072#1082#1083#1072#1076#1085#1099#1077' '#1080#1085#1074#1077#1085#1090#1072#1088#1080#1079#1072#1094#1080#1080
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
        Font.Name = 'arial'
  ...
  object grid_invent: TcxGrid
    ...
    object grid_invent_v: TcxGridDBTableView
      PopupMenu = pm_invent
      OnDblClick = grid_invent_vDblClick
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Format = '0'
          Kind = skSum
          Column = grid_invent_vsum_quantity
        end>
      ...
      object grid_invent_vbrief: TcxGridDBColumn
      ...
      object grid_invent_vID_DOC: TcxGridDBColumn
        DataBinding.FieldName = 'ID_DOC'
        Visible = False
      end
      object grid_invent_vID_DOC_TYPE: TcxGridDBColumn
        DataBinding.FieldName = 'ID_DOC_TYPE'
        Visible = False
      end
      object grid_invent_vID_DEPARTMENTS: TcxGridDBColumn
        DataBinding.FieldName = 'ID_DEPARTMENTS'
        Visible = False
      end
      object grid_invent_vDEPARTMENT_NAME: TcxGridDBColumn
        DataBinding.FieldName = 'DEPARTMENT_NAME'
        Visible = False
      end
      object grid_invent_vOPERATOR_NAME: TcxGridDBColumn
      ...
      object grid_invent_vID_CLIENT: TcxGridDBColumn
        DataBinding.FieldName = 'ID_CLIENT'
        Visible = False
      end
      object grid_invent_vNICK: TcxGridDBColumn
        DataBinding.FieldName = 'NICK'
        Visible = False
      end
      object grid_invent_vFIO: TcxGridDBColumn
        DataBinding.FieldName = 'FIO'
        Visible = False
      end
      object grid_invent_vSUM_PRICE_OLD: TcxGridDBColumn
        DataBinding.FieldName = 'SUM_PRICE_OLD'
        Visible = False
      end
      object grid_invent_vSUM_PRICE_NEW: TcxGridDBColumn
        DataBinding.FieldName = 'SUM_PRICE_NEW'
        Visible = False
      end
      object grid_invent_vSUM_PRICE_DIFFERENCE: TcxGridDBColumn
        DataBinding.FieldName = 'SUM_PRICE_DIFFERENCE'
        Visible = False
      end
      object grid_invent_vINV_ID: TcxGridDBColumn
        DataBinding.FieldName = 'INV_ID'
        Visible = False
      end
      object grid_invent_vORDER_ID: TcxGridDBColumn
        DataBinding.FieldName = 'ORDER_ID'
        Visible = False
      end
      object grid_invent_vSUPPLIER_DATE: TcxGridDBColumn
        DataBinding.FieldName = 'SUPPLIER_DATE'
        Visible = False
      end
      object grid_invent_vSUPPLIER_NUMBER: TcxGridDBColumn
        DataBinding.FieldName = 'SUPPLIER_NUMBER'
        Visible = False
      end
      object grid_invent_vSUPLIER: TcxGridDBColumn
        DataBinding.FieldName = 'SUPLIER'
        Visible = False
      end
      object grid_invent_vid_office: TcxGridDBColumn
        DataBinding.FieldName = 'id_office'
        Visible = False
      end
      object grid_invent_vsum_quantity: TcxGridDBColumn
    ...
    object grid_invent_l: TcxGridLevel
      GridView = grid_invent_v
    end
  end
  ...
  object doc_data: TOraQuery
    ...
    SQL.Strings = (
      ...
      'PRICE_LIST,'
      'GTD,'
      'SPESIFICATION, COMPILED_NAME_OTDEL, photo'
      'from'
      'store_docdata_view'
      'where'
      'ID_DOC = :ID_DOC'
  ...
  object SaveDialog11: TSaveDialog
    DefaultExt = 'xls'
    Filter = #1060#1072#1081#1083#1099' EXCEL (*.xls)|*.xls'
    Left = 865
    Top = 81
  end
  object bm_invent: TdxBarManager
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'Tahoma'
  ...
  object pm_invent: TdxBarPopupMenu
    BarManager = bm_invent
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 41415.956505300930000000
    ReportOptions.LastChange = 41415.956505300930000000
