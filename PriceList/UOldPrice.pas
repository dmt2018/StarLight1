...
//    frmOldPrice.DictView.Close;
//    frmOldPrice.DictView.ParamByName('DEPT_').AsInteger := CUR_DEPT_ID;
...
begin
  try
    sql := 'begin price_pkg.sync_price_list(:in_ppli_id, :v_code, :v_price, :v_gtd); end;';
    qTMP.Close;
    qTMP.sql.text := sql;
    qTMP.ParamByName('in_ppli_id').AsInteger := DM.PPL_Index.FieldByName('PPLI_ID').Value;
