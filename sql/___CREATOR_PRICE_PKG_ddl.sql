...
-- Generated 29.03.2015 21:54:48 from CREATOR@STAR_NEW
...
BEGIN
  ...
  open cursor_ for
    select a.ppli_id, a.ppl_id, a.coming_date, a.invoice_amount
       --, d.DISTRIBUTED_NUMBER, (a.invoice_amount-d.DISTRIBUTED_NUMBER) as obshak
       ...
       , a.price_pcc, a.price_pcc_pc, a.n_id, a.final_price, a.inv_total_sum, a.stok_total_sum, a.inv_total_profit, a.came_type, a.nid_rownum, a.f_sub_type
    ...
    from (
      SELECT ppli_id, ppl_id, coming_date, invoice_amount, stock_amount, left_amount, given_amount, hol_price, ruble_price, last_price
        , price_pcc, price_pcc_pc, n_id, final_price, inv_total_sum, stok_total_sum, inv_total_profit, stok_total_profit
        , compiled_name_otdel, total_sum, total_profit, cust_coef, h_code, nvl(COL,0) as col
        ...
        , row_number() over(partition by n_id order by ppl_id) as nid_rownum
        , country, colour, bar_code, code, ft_id, fst_id, col_id, len, type_subtype, spec_price, best_price, discount
        , inv_id, inv_id2, inv_id3, inv_id4
      FROM ppl_view
        WHERE PPLI_ID = v_PPLI_ID
    ) a
    --left outer join distributions_invoices di on di.INV_ID = a.inv_id or di.INV_ID = a.inv_id2 or di.INV_ID = a.inv_id3 or di.INV_ID = a.inv_id4
