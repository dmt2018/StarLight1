...
--LOG_ERR('поиск клиента', 1, 'distribution_pkg.convert_client', 'v_id_client='||v_id_client);
...
/* Пробовал пойти от инвойса. Пока не нужно. Потом удалить
...
begin
  ...
  WHEN OTHERS THEN
       ...
       RAISE_APPLICATION_ERROR (-20248, 'Запрос не выполнился. ' || SQLERRM || ' ' || DBMS_UTILITY.format_error_backtrace);
