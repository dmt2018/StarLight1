...
-- Generated 10.12.2011 18:19:44 from CREATOR@STARREG
...
select N_ID, CODE, H_CODE, F_TYPE, F_SUB_TYPE, FT_ID, FST_ID, full_name, QUANTITY_NOW,
       ...
       QUANTITY, added, (QUANTITY * price) as QUANTITY_PRICE,
...
(
        select a.N_ID, a.CODE, a.H_CODE, a.F_TYPE, a.F_SUB_TYPE, a.FT_ID, a.FST_ID, a.full_name, a.spesification,
               ...
               , a.COMPILED_NAME_OTDEL, a.id_office, a.brief 
        from
        store_doc_data_temp b,
        (
          select a.N_ID, a.CODE, a.H_CODE, a.F_TYPE, a.F_SUB_TYPE, a.FT_ID, a.FST_ID, a.full_name,
...
/
create or replace public synonym store_docdatatemp_view for creator.store_docdatatemp_view
/
