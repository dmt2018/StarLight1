...
-- Generated 10.12.2011 1:11:19 from CREATOR@STARREG
...
SELECT C.ID_CLIENTS, UPPER(C.NICK) as NICK, UPPER(C.FIO) as FIO, C.DDATE, C.CCODE,
       ...
       , c.email, c.address
       , c.id_office, o.brief
       --, row_number() over (partition by 1 order by C.NICK) as nn,
   FROM CLIENTS C, CLIENTS_GROUPS G, books_regions r, books_client_TYPES T, offices o
...
create or replace public synonym clients_view2 for creator.clients_view2
/
