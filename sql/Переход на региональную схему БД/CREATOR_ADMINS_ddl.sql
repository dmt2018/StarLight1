...
-- Generated 10.12.2011 20:36:08 from CREATOR@STARREG
...
IS
   ...
   BEGIN
       if id_ > 0 then
          update ADMIN_ROLE_GROUPS set NAME = name_, info = info_, date_change = sysdate where ID_ROLE_GROUPS = id_;
       else
...
create or replace public synonym admins for creator.admins
/
