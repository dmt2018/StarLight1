-- Start of DDL Script for View CREATOR.STORE_VIEW
-- Generated 10.12.2011 18:20:16 from CREATOR@STARREG
...
-- Grants for View
GRANT SELECT ON store_view TO new_role
/
create or replace public synonym store_view for creator.store_view
/
-- End of DDL Script for View CREATOR.STORE_VIEW
