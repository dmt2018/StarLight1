...
-- Generated 24.01.2016 2:14:49 from CREATOR@STAR_NEW
...
select a.ID_DOC, a.DOC_NUMBER, a.ID_CLIENT, a.ID_DEPARTMENTS, a.OPERATOR_NAME, a.DOC_DATE, a.DOC_DATE_REAL, a.BEZNDSMINUS, a.BEZNDS,
    ...
    to_char(a.id_office,'09') || '/' || CASE WHEN a.DOC_NUMBER_ADD is not null THEN case when a.DOC_NUMBER_ADD = 'О' then a.DOC_NUMBER_ADD || a.DOC_NUMBER else a.DOC_NUMBER||'/'||a.DOC_NUMBER_ADD end
