...
type
  TDM = class(TDataModule)
    ...
    InvoiceAsIsHEIGHT: TFloatField;
    InvoiceAsIsDIAMETR: TFloatField;
    ...
    InvoiceAsIsRECOGNISED: TFloatField;
    ...
    InvoiceAsIsID: TFloatField;
    InvoiceAsIsFT_ID: TFloatField;
    ...
    InvoiceAsIsCUST_VALUE: TFloatField;
    InvoiceAsIsCUST_NORM: TFloatField;
  private
