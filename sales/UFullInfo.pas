...
type
  Tfrm_full_info = class(TForm)
    ...
    tshOrder: TcxTabSheet;
    cdsOrders: TOraQuery;
    dsOrders: TOraDataSource;
    cdsOrdersNICK: TStringField;
    cdsOrdersID_ORDERS_CLIENTS: TFloatField;
    cdsOrdersSTATUS: TStringField;
    cdsOrdersN_TYPE: TStringField;
    cdsOrdersN_TRUCK: TIntegerField;
    cdsOrdersD_DATE: TDateTimeField;
    cdsOrdersON_DATE: TDateTimeField;
    cdsOrdersINFO: TStringField;
    DBGridEh1: TDBGridEh;
    cdsOrdersID_ORDERS_LIST: TFloatField;
    cdsOrdersQUANTITY: TIntegerField;
    cdsOrdersN_ID: TFloatField;
    cxLabel5: TcxLabel;
    cxLabel6: TcxLabel;
...
begin
  ...
  try
    ...
    cdsOrders.Close;
    cdsOrders.ParamByName('p_n_id').AsInteger := SelNom.FieldByName('N_ID').Value;
    cdsOrders.Open;
  finally
    tq.Free;
  end;
