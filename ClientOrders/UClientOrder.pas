...
type
  TfrmClientOrders = class(TForm)
    ...
    oraSQL: TOraQuery;
    Q_DISTR_LISTSTORE_TYPE: TIntegerField;
    Q_DISTR_LISTID_DEPARTMENTS: TIntegerField;
    Q_DISTR_LISTFULL_NAME: TStringField;
    Q_DISTR_LISTF_NAME: TStringField;
    Q_DISTR_LISTF_NAME_RU: TStringField;
    Q_DISTR_LISTF_TYPE: TStringField;
    Q_DISTR_LISTF_SUB_TYPE: TStringField;
    Q_DISTR_LISTCODE: TStringField;
    Q_DISTR_LISTLEN: TIntegerField;
    Q_DISTR_LISTPACK: TIntegerField;
    Q_DISTR_LISTCOLOUR: TStringField;
    Q_DISTR_LISTCOL_ID: TFloatField;
    Q_DISTR_LISTFT_ID: TFloatField;
    Q_DISTR_LISTFST_ID: TFloatField;
    Q_DISTR_LISTFN_ID: TFloatField;
    Q_DISTR_LISTS_ID: TFloatField;
    Q_DISTR_LISTC_ID: TFloatField;
    Q_DISTR_LISTH_CODE: TStringField;
    Q_DISTR_LISTH_NAME: TStringField;
    Q_DISTR_LISTS_NAME_RU: TStringField;
    Q_DISTR_LISTCOUNTRY: TStringField;
    Q_DISTR_LISTN_ID: TFloatField;
    Q_DISTR_LISTPRICE_LIST: TFloatField;
    Q_DISTR_LISTRESERV: TFloatField;
    Q_DISTR_LISTITOGO: TFloatField;
    Q_DISTR_LISTID_ORDERS_LIST: TFloatField;
    Q_DISTR_LISTQUANTITY: TIntegerField;
    Q_DISTR_LISTQUANTITY_PRICE: TFloatField;
    Q_DISTR_LISTPRICE: TFloatField;
    Q_DISTR_LISTPRICE_PERCENT: TFloatField;
    Q_DISTR_LISTSPESIFICATION: TStringField;
    Q_DISTR_LISTSTORE_TYPE_NAME: TStringField;
    Q_DISTR_LISTCOMPILED_NAME_OTDEL: TStringField;
    Q_DISTR_LISTOUR_CODE: TStringField;
    Q_DISTR_LISTSTORE: TFloatField;
    Q_DISTR_LISTNOTUSE: TIntegerField;
...
begin
  ...
  if (cdsOrders.RecordCount = 0) or (cdsClients.RecordCount = 0) or not cdsClients.Filtered then exit;
    ...
    try
      ...
      Q_DISTR_LIST.ParamByName('vdat').AsString := grOrdersview.DataController.DataSet.FieldByname('DATE_TRUCK').Value;
      Q_DISTR_LIST.Open;
